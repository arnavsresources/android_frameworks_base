...
import awaken.providers.AwakenSettings;
...
public class NotificationShadeWindowControllerImpl implements NotificationShadeWindowController,
    ...
    private boolean shouldEnableKeyguardScreenRotation() {
        ...
        boolean enableLockScreenRotation =
                AwakenSettings.System.getInt(mContext.getContentResolver(),
                AwakenSettings.System.LOCKSCREEN_ROTATION, 0) != 0;
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        public void observe(Context context) {
            context.getContentResolver().registerContentObserver(
                    ...
                    false, this);
            context.getContentResolver().registerContentObserver(
                    AwakenSettings.System.getUriFor(AwakenSettings.System.LOCKSCREEN_ROTATION),
                    false, this);
        }
